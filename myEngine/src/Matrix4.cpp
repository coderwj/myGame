...
void Matrix4::initWithLookAt(const Vector3 &eye, const Vector3 &center, const Vector3 &up)
{
    ...
    m11 = s.x;          m12 = u.x;          m13 = -f.x;        m14 = 0.0f;
    m21 = s.y;          m22 = u.y;          m23 = -f.y;        m24 = 0.0f;
    m31 = s.z;          m32 = u.z;          m33 = -f.z;        m34 = 0.0f;
    m41 = -(s * eye);   m42 = -(u * eye);   m43 = (f * eye);   m44 = 1.0f;
}
