...
shaderc -f pbr_gltf_vs.sc -o ..\shaderbin\pbr_gltf_vs.bin --define %def_v% --varyingdef pbr_gltf_varying.def.sc --platform ios --type vertex -O3
shaderc -f pbr_gltf_fs.sc -o ..\shaderbin\pbr_gltf_fs.bin --define %def_f% --varyingdef pbr_gltf_varying.def.sc --platform ios --type fragment -O3